...
/** Model-family key. Deliberately fixed, so it keeps meaning across stations. */
export function Legend3() {
  return (
    <div className="legend">
      <span><span className="swatch" style={{ background: FAMILY.tree }} />Tree</span>
      <span><span className="swatch" style={{ background: FAMILY.neural }} />Neural</span>
      <span><span className="swatch" style={{ background: FAMILY.hybrid }} />Hybrid</span>
    </div>
  );
}
