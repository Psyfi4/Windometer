 ...
 *
 * One wheel detent travels an eighth of the viewport, so eight take you a full
 * page and a stage boundary lands exactly on a detent.
 *
...
export function useSmoothScroll(ref, {
  ...
  pageFraction = 0.125, // a full 100-unit detent travels an eighth of the
                        // viewport — close to what a browser does natively
  ...
  snapMaxPull = 0.07,   // settle only within this fraction of the viewport.
