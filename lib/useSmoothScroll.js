 ...
 *
 * One wheel detent travels a quarter of the viewport, so four take you a full
...
export function useSmoothScroll(ref, {
  enabled = true,
  smoothTime = 0.035,   // spring response; a quarter-page hop lands in ~0.13 s
                        // across 8 frames. Below about 0.025 a hop spans
  ...
  pageFraction = 0.25,  // a full 100-unit detent travels a quarter viewport
  ...
  snapMaxPull = 0.14,   // settle only within this fraction of the viewport.
