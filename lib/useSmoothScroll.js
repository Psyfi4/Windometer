 ...
 *
 * One wheel detent travels a full viewport, so a stage boundary lands exactly
 * on a detent.
 *
...
export function useSmoothScroll(ref, {
  enabled = true,
  smoothTime = 0.035,   // spring response; a full-page hop lands in ~0.17 s
                        // across 10 frames. Below about 0.025 a hop spans
  ...
  pageFraction = 1.0,   // a full 100-unit detent travels a whole viewport
